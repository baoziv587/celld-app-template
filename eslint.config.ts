...
export default antfu(
  {
    ...
    ignores: [
      ...
      '**/.tanstack',
      // Generated: by the shadcn CLI (keep it diffable against upstream) and by TanStack Router.
      '**/components/ui',
      '**/routeTree.gen.ts',
    ],
  },
  ...
  {
    // TanStack Router route files export `Route` next to their component by design.
